...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ua(e,t,n){let r=new Float32Array(ka),i=new U(0,1,0);return new wi({name:`SphericalGaussianBlur`,defines:{n:ka,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Ka(),fragmentShader:`
	...
	`}var qa=class extends Jt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new ui(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var _s={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function vs(e,t){let n=_s[t];return n===void 0?(B(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var ys=new U;function bs(){return G.getLuminanceCoefficients(ys),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${ys.x.toFixed(4)}, ${ys.y.toFixed(4)}, ${ys.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
`;function Pc({className:e}){let t=(0,_.useRef)(null);return(0,_.useEffect)(()=>{let e=t.current;if(!e)return;let n=window.matchMedia(`(prefers-reduced-motion: reduce)`).matches,r=new Ac({canvas:e,alpha:!0,antialias:!0,powerPreference:`high-performance`});r.setClearColor(0,0),r.setPixelRatio(Math.min(window.devicePixelRatio,2));let i=new Fn,a=new Ki,o=new hi(2,2),s={uTime:{value:0},uExcite:{value:0},uPointer:{value:new Ot(-1,-1)}},c=new wi({vertexShader:Mc,fragmentShader:Nc,uniforms:s,transparent:!0,blending:2,depthTest:!1,depthWrite:!1});i.add(new Qr(o,c));let l=()=>{let{width:t,height:n}=e.getBoundingClientRect();r.setSize(t,n,!1)},u=new ResizeObserver(l);u.observe(e),l();let d=0,f=t=>{let n=e.getBoundingClientRect();s.uPointer.value.set((t.clientX-n.left)/n.width,1-(t.clientY-n.top)/n.height),d=1},p=()=>{d=0};e.addEventListener(`pointermove`,f),e.addEventListener(`pointerleave`,p);let m=0,h=performance.now(),g=e=>{s.uTime.value=n?2.4:(e-h)/1e3,s.uExcite.value+=(d-s.uExcite.value)*.07,r.render(i,a),n||(m=requestAnimationFrame(g))};return g(h),()=>{cancelAnimationFrame(m),u.disconnect(),e.removeEventListener(`pointermove`,f),e.removeEventListener(`pointerleave`,p),o.dispose(),c.dispose(),r.dispose()}},[]),(0,Z.jsx)(`canvas`,{ref:t,className:e})}function Fc(){return(0,Z.jsxs)(`main`,{children:[(0,Z.jsxs)(`header`,{className:`site-header`,children:[(0,Z.jsxs)(`a`,{className:`brand`,href:`#top`,"aria-label":`Portal home`,children:[(0,Z.jsx)(`span`,{"aria-hidden":`true`,children:`>_`}),(0,Z.jsx)(`strong`,{children:`PORTAL`})]}),(0,Z.jsxs)(`div`,{className:`header-meta`,children:[(0,Z.jsx)(`span`,{children:`MAC + IPHONE`}),(0,Z.jsx)(`a`,{href:`/portal/security/`,children:`SECURITY`}),(0,Z.jsx)(`a`,{href:`#inside`,children:`SEE INSIDE`})]})]}),(0,Z.jsxs)(`section`,{className:`hero`,id:`top`,children:[(0,Z.jsxs)(`div`,{className:`hero-copy`,children:[(0,Z.jsxs)(`p`,{className:`eyebrow`,children:[(0,Z.jsx)(`span`,{className:`live-dot`}),`Native terminal. Zero configuration.`]}),(0,Z.jsxs)(`h1`,{children:[(0,Z.jsx)(`span`,{children:`Give your`}),(0,Z.jsx)(`span`,{children:`Mac a`}),(0,Z.jsx)(`span`,{className:`gradient-text`,children:`portal.`})]}),(0,Z.jsx)(`p`,{className:`lede`,children:`Portal is a delightful, opinionated terminal app for Mac and iPhone. Your Macs appear automatically through iCloud—no Portal account, no setup, no configuration. Just open the app.`}),(0,Z.jsxs)(`a`,{className:`primary-action`,href:`#inside`,children:[`Enter Portal`,(0,Z.jsx)(`span`,{"aria-hidden":`true`,children:`↓`})]})]}),(0,Z.jsxs)(`div`,{className:`portal-stage`,"aria-hidden":`true`,children:[(0,Z.jsx)(`div`,{className:`portal-aura`}),(0,Z.jsx)(`img`,{className:`portal-core`,src:`/portal/portal-icon.png`,alt:``}),(0,Z.jsx)(Pc,{className:`portal-electric`}),(0,Z.jsx)(`div`,{className:`portal-flare`})]}),(0,Z.jsxs)(`div`,{className:`hero-index`,"aria-hidden":`true`,children:[(0,Z.jsx)(`span`,{children:`001`}),(0,Z.jsx)(`i`,{}),(0,Z.jsx)(`span`,{children:`PORTAL / TERMINAL`})]})]}),(0,Z.jsxs)(`section`,{className:`statement`,id:`inside`,children:[(0,Z.jsx)(`p`,{className:`section-kicker`,children:`01 / Persistent by default`}),(0,Z.jsxs)(`h2`,{children:[`Portal into`,(0,Z.jsx)(`br`,{}),(0,Z.jsx)(`span`,{children:`your terminal.`})]}),(0,Z.jsxs)(`p`,{className:`statement-copy`,children:[`Sessions stay put until you `,(0,Z.jsx)(`code`,{children:`exit`}),`. Close the tab, quit Portal, or switch devices. Jump straight back in whenever the host Mac is awake.`,(0,Z.jsx)(`small`,{children:`Your iCloud account connects your devices. No Portal account. No SSH. End-to-end encrypted.`})]})]}),(0,Z.jsxs)(`section`,{className:`product-shot`,children:[(0,Z.jsxs)(`div`,{className:`shot-frame`,children:[(0,Z.jsxs)(`div`,{className:`shot-bar`,children:[(0,Z.jsx)(`span`,{children:`PORTAL / AVAILABLE SESSIONS`}),(0,Z.jsx)(`span`,{children:`REJOIN ANYWHERE`})]}),(0,Z.jsx)(`video`,{src:`/portal/portal-terminal-natural-loop.webm`,poster:`/portal/portal-terminal-natural-loop.jpg`,"aria-label":`Portal showing terminal sessions ready to rejoin`,autoPlay:!0,loop:!0,muted:!0,playsInline:!0})]}),(0,Z.jsxs)(`p`,{className:`shot-caption`,children:[(0,Z.jsx)(`span`,{children:`01`}),`Sessions stay put until you end them.`]})]}),(0,Z.jsxs)(`section`,{className:`sync`,children:[(0,Z.jsxs)(`div`,{className:`sync-copy`,children:[(0,Z.jsx)(`p`,{className:`section-kicker`,children:`02 / Live everywhere`}),(0,Z.jsxs)(`h2`,{children:[`One session.`,(0,Z.jsx)(`br`,{}),`Every screen.`]}),(0,Z.jsx)(`p`,{children:`Type on your Mac. Watch it appear on your iPhone. Use both at once, alongside every other Mac and iPhone you own.`})]}),(0,Z.jsxs)(`div`,{className:`device-stage`,role:`img`,"aria-label":`A command typed on a Mac appearing live on an iPhone`,children:[(0,Z.jsxs)(`div`,{className:`mac-device`,children:[(0,Z.jsxs)(`div`,{className:`device-bar`,children:[(0,Z.jsx)(`i`,{}),(0,Z.jsx)(`i`,{}),(0,Z.jsx)(`i`,{}),(0,Z.jsx)(`span`,{children:`portal — zsh`})]}),(0,Z.jsxs)(`div`,{className:`device-terminal`,children:[(0,Z.jsxs)(`p`,{children:[(0,Z.jsx)(`span`,{className:`prompt`,children:`❯`}),` `,(0,Z.jsx)(`span`,{className:`typed-command`,children:`npm run ship`})]}),(0,Z.jsx)(`p`,{className:`terminal-output`,children:`✓ release published`})]})]}),(0,Z.jsxs)(`div`,{className:`connection-beam`,children:[(0,Z.jsx)(`i`,{}),(0,Z.jsx)(`i`,{}),(0,Z.jsx)(`i`,{})]}),(0,Z.jsxs)(`div`,{className:`phone-device`,children:[(0,Z.jsx)(`div`,{className:`phone-island`}),(0,Z.jsx)(`span`,{className:`phone-label`,children:`PORTAL · LIVE`}),(0,Z.jsxs)(`div`,{className:`device-terminal`,children:[(0,Z.jsxs)(`p`,{children:[(0,Z.jsx)(`span`,{className:`prompt`,children:`❯`}),` `,(0,Z.jsx)(`span`,{className:`typed-command`,children:`npm run ship`})]}),(0,Z.jsx)(`p`,{className:`terminal-output`,children:`✓ release published`})]})]})]})]}),(0,Z.jsxs)(`section`,{className:`no-rituals`,children:[(0,Z.jsx)(`p`,{className:`section-kicker`,children:`03 / Zero ceremony`}),(0,Z.jsx)(`h2`,{children:`Just works.`}),(0,Z.jsx)(`p`,{className:`rituals-copy`,children:`No servers to configure. No sessions to babysit. No networking archaeology.`}),(0,Z.jsx)(`div`,{className:`rituals`,"aria-label":`Tools Portal does not require`,children:[`ssh`,`mosh`,`screen`,`tmux`].map(e=>(0,Z.jsx)(`code`,{children:e},e))})]}),(0,Z.jsxs)(`section`,{className:`autocomplete`,children:[(0,Z.jsxs)(`div`,{className:`completion-demo`,"aria-hidden":`true`,children:[(0,Z.jsxs)(`div`,{className:`completion-input`,children:[(0,Z.jsx)(`span`,{children:`❯`}),(0,Z.jsx)(`strong`,{children:`git che`}),(0,Z.jsx)(`i`,{})]}),(0,Z.jsxs)(`div`,{className:`completion-menu`,children:[(0,Z.jsxs)(`p`,{className:`selected`,children:[(0,Z.jsx)(`strong`,{children:`checkout`}),(0,Z.jsx)(`span`,{children:`Switch branches or restore files`})]}),(0,Z.jsxs)(`p`,{children:[(0,Z.jsx)(`strong`,{children:`cherry-pick`}),(0,Z.jsx)(`span`,{children:`Apply changes from a commit`})]}),(0,Z.jsxs)(`p`,{children:[(0,Z.jsx)(`strong`,{children:`check-ignore`}),(0,Z.jsx)(`span`,{children:`Debug gitignore files`})]})]})]}),(0,Z.jsxs)(`div`,{className:`autocomplete-copy`,children:[(0,Z.jsx)(`p`,{className:`section-kicker`,children:`04 / Autocomplete, completed`}),(0,Z.jsx)(`h2`,{children:`Every CLI. Already fluent.`}),(0,Z.jsx)(`p`,{children:`State-of-the-art completions without hunting for completion files or configuring Oh My Zsh. Fast on your Mac. Just as instant when you portal in from iPhone.`})]})]}),(0,Z.jsxs)(`section`,{className:`beauty`,children:[(0,Z.jsxs)(`div`,{className:`beauty-copy`,children:[(0,Z.jsx)(`p`,{className:`section-kicker`,children:`05 / Native to the core`}),(0,Z.jsxs)(`h2`,{children:[`Powerful can`,(0,Z.jsx)(`br`,{}),`be beautiful.`]}),(0,Z.jsx)(`p`,{children:`Proper macOS blur, vibrancy, and translucency. The terminal finally belongs beside your best apps.`})]}),(0,Z.jsx)(`div`,{className:`beauty-shot`,children:(0,Z.jsx)(`img`,{src:`/portal/session-blocks.webp`,alt:`Portal’s translucent macOS interface over a colorful desktop`})})]}),(0,Z.jsxs)(`section`,{className:`craft`,children:[(0,Z.jsxs)(`div`,{className:`craft-copy`,children:[(0,Z.jsx)(`p`,{className:`section-kicker`,children:`06 / Native by experience`}),(0,Z.jsxs)(`h2`,{children:[`Built by Mac`,(0,Z.jsx)(`br`,{}),`and iPhone builders.`]}),(0,Z.jsx)(`p`,{children:`Portal comes from the creator of Homebrew and longtime Mac and iPhone app builders. We built the details we expect when we sit down at a Mac or pick up a phone.`})]}),(0,Z.jsxs)(`ul`,{className:`craft-details`,children:[(0,Z.jsxs)(`li`,{children:[(0,Z.jsx)(`span`,{"aria-hidden":`true`,children:`⌘⇧T`}),(0,Z.jsxs)(`div`,{children:[(0,Z.jsx)(`h3`,{children:`Closed tabs come back.`}),(0,Z.jsx)(`p`,{children:`Close one with ⌘W. Reopen it with ⌘⇧T, even after relaunching Portal.`})]})]}),(0,Z.jsxs)(`li`,{children:[(0,Z.jsx)(`span`,{"aria-hidden":`true`,children:`⌘F`}),(0,Z.jsxs)(`div`,{children:[(0,Z.jsx)(`h3`,{children:`The Edit menu works.`}),(0,Z.jsx)(`p`,{children:`Cut, copy, paste, select all, and history search use the Mac shortcuts already in your hands.`})]})]}),(0,Z.jsxs)(`li`,{children:[(0,Z.jsx)(`span`,{"aria-hidden":`true`,children:`iOS`}),(0,Z.jsxs)(`div`,{children:[(0,Z.jsx)(`h3`,{children:`The keyboard makes room.`}),(0,Z.jsx)(`p`,{children:`Show or dismiss it without leaving your session. Completions appear as you type.`})]})]})]})]}),(0,Z.jsxs)(`section`,{className:`linux`,children:[(0,Z.jsx)(`span`,{children:`07 / NEXT DESTINATION`}),(0,Z.jsx)(`h2`,{children:`Linux is through the next portal.`}),(0,Z.jsx)(`p`,{children:`Coming soon.`}),(0,Z.jsxs)(`a`,{className:`primary-action`,href:`#top`,children:[`Back to the portal`,(0,Z.jsx)(`span`,{"aria-hidden":`true`,children:`↑`})]})]}),(0,Z.jsxs)(`footer`,{children:[(0,Z.jsxs)(`a`,{className:`brand`,href:`#top`,children:[(0,Z.jsx)(`span`,{"aria-hidden":`true`,children:`>_`}),(0,Z.jsx)(`strong`,{children:`PORTAL`})]}),(0,Z.jsx)(`p`,{children:(0,Z.jsx)(`a`,{href:`/portal/security/`,children:`SECURITY`})}),(0,Z.jsx)(`p`,{children:`© 2026`})]})]})}var Ic=[{label:`Local session`,route:`Portal → private Unix socket → session daemon`,boundary:`Never leaves the Mac`},{label:`Mac ↔ iPhone`,route:`Device → encrypted envelope → Portal relay → device`,boundary:`Leaves the local network`},{label:`SSH host`,route:`Portal → system SSH client → configured host`,boundary:`Follows the host’s network route`}];function Lc(){return(0,Z.jsxs)(`main`,{className:`security-page`,children:[(0,Z.jsxs)(`header`,{className:`security-header`,children:[(0,Z.jsxs)(`a`,{className:`brand`,href:`/portal/`,"aria-label":`Portal home`,children:[(0,Z.jsx)(`span`,{"aria-hidden":`true`,children:`>_`}),(0,Z.jsx)(`strong`,{children:`PORTAL`})]}),(0,Z.jsx)(`a`,{href:`/portal/`,children:`BACK TO PORTAL`})]}),(0,Z.jsxs)(`article`,{className:`security-article`,children:[(0,Z.jsxs)(`div`,{className:`security-hero`,children:[(0,Z.jsx)(`p`,{className:`section-kicker`,children:`Security model / July 2026`}),(0,Z.jsx)(`h1`,{children:`What leaves your Mac.`}),(0,Z.jsx)(`p`,{className:`security-lede`,children:`Portal keeps local terminal sessions local. Remote access is opt-in, outbound-only, and end-to-end encrypted before terminal data reaches the relay.`})]}),(0,Z.jsxs)(`section`,{className:`network-paths`,"aria-labelledby":`network-paths-title`,children:[(0,Z.jsxs)(`div`,{children:[(0,Z.jsx)(`p`,{className:`section-kicker`,children:`01 / Network boundaries`}),(0,Z.jsx)(`h2`,{id:`network-paths-title`,children:`Three paths. Three boundaries.`})]}),(0,Z.jsx)(`ol`,{children:Ic.map(e=>(0,Z.jsxs)(`li`,{children:[(0,Z.jsx)(`strong`,{children:e.label}),(0,Z.jsx)(`span`,{children:e.route}),(0,Z.jsx)(`em`,{children:e.boundary})]},e.label))}),(0,Z.jsx)(`p`,{children:`A normal local session uses a per-user Unix domain socket with owner-only permissions. Portal opens no TCP port and advertises no terminal service on your LAN.`}),(0,Z.jsx)(`p`,{children:`When remote access is enabled, the Mac opens an outbound secure WebSocket to Portal’s relay and uploads an encrypted session catalog over HTTPS. The iPhone uses the same relay. This happens even when both devices are on the same Wi-Fi: Portal does not attempt local peer-to-peer routing.`}),(0,Z.jsx)(`p`,{children:`Separately, a configured SSH session uses macOS's system SSH client and its existing host-key and key-agent trust. That traffic reaches the host directly; it is not sent through Portal’s relay.`})]}),(0,Z.jsxs)(`section`,{"aria-labelledby":`encryption-title`,children:[(0,Z.jsx)(`p`,{className:`section-kicker`,children:`02 / Keys and encryption`}),(0,Z.jsx)(`h2`,{id:`encryption-title`,children:`The relay delivers ciphertext.`}),(0,Z.jsx)(`p`,{children:`Portal creates a random 256-bit account root key on-device and stores it as a synchronizable iCloud Keychain item. Devices signed into the same Apple account use that shared key to derive separate keys and opaque identifiers for relay routing, relay authorization, live terminal traffic, and the session catalog.`}),(0,Z.jsx)(`p`,{children:`Terminal messages and catalog snapshots are sealed with AES-256-GCM and purpose-bound authenticated data before upload. TLS protects the connection in transit as an additional layer, but the relay never receives the encryption key or plaintext terminal contents.`})]}),(0,Z.jsxs)(`section`,{"aria-labelledby":`relay-title`,children:[(0,Z.jsx)(`p`,{className:`section-kicker`,children:`03 / Relay knowledge`}),(0,Z.jsx)(`h2`,{id:`relay-title`,children:`What the service can—and cannot—see.`}),(0,Z.jsxs)(`div`,{className:`security-columns`,children:[(0,Z.jsxs)(`div`,{children:[(0,Z.jsx)(`h3`,{children:`The relay can see`}),(0,Z.jsxs)(`ul`,{children:[(0,Z.jsx)(`li`,{children:`Connection addresses, timing, and message sizes`}),(0,Z.jsx)(`li`,{children:`An opaque room identifier and the number of live peers`}),(0,Z.jsx)(`li`,{children:`An encrypted session-catalog blob`})]})]}),(0,Z.jsxs)(`div`,{children:[(0,Z.jsx)(`h3`,{children:`The relay cannot see`}),(0,Z.jsxs)(`ul`,{children:[(0,Z.jsx)(`li`,{children:`Commands, keystrokes, output, paths, or session names`}),(0,Z.jsx)(`li`,{children:`The account root key or purpose-derived encryption keys`}),(0,Z.jsx)(`li`,{children:`Data needed to forge a new authenticated command`})]})]})]}),(0,Z.jsx)(`p`,{children:`The relay has two storage classes, and neither contains plaintext:`}),(0,Z.jsxs)(`dl`,{className:`relay-storage`,children:[(0,Z.jsxs)(`div`,{children:[(0,Z.jsx)(`dt`,{children:`Temporary / memory only`}),(0,Z.jsx)(`dd`,{children:`Each encrypted terminal frame exists only long enough to be broadcast to the other connected peers. Peer identifiers exist while their sockets are connected; opaque room and authorization state may remain until the relay process restarts.`})]}),(0,Z.jsxs)(`div`,{children:[(0,Z.jsx)(`dt`,{children:`Durable / stored on disk`}),(0,Z.jsx)(`dd`,{children:`One encrypted session-catalog blob per opaque room. Each update atomically replaces the previous blob—there is no catalog history. A blob inactive for 30 days is deleted on its next read; production billing cleanup may delete it sooner after a subscription expires.`})]}),(0,Z.jsxs)(`div`,{children:[(0,Z.jsx)(`dt`,{children:`Never stored by the relay`}),(0,Z.jsx)(`dd`,{children:`Plaintext commands, keystrokes, output, paths, session names, the account root key, and derived encryption keys. The relay implementation does not persist or log live terminal frames.`})]})]}),(0,Z.jsx)(`p`,{children:`Portal defines no permanent relay record: the catalog is retained only for device discovery and is subject to deletion. Hosting and network providers may keep ordinary connection metadata under their own operational policies; that metadata is outside Portal’s end-to-end encryption boundary.`})]}),(0,Z.jsxs)(`section`,{"aria-labelledby":`control-title`,children:[(0,Z.jsx)(`p`,{className:`section-kicker`,children:`04 / Control and failure modes`}),(0,Z.jsx)(`h2`,{id:`control-title`,children:`Encryption is not availability.`}),(0,Z.jsx)(`p`,{children:`A compromised relay can delay, drop, duplicate, reorder, or replay ciphertext and can deny service. Sequence numbers are inside the authenticated message; clients reject duplicate or stale terminal events and reconnect for a fresh canonical snapshot after a gap.`}),(0,Z.jsx)(`p`,{children:`The Mac initiates every relay connection, so the service cannot open an inbound connection to it. Phone-role clients may send terminal input but cannot change PTY geometry. On iPhone, attaching to a session requires device-owner authentication.`})]}),(0,Z.jsxs)(`section`,{className:`security-limits`,"aria-labelledby":`limits-title`,children:[(0,Z.jsx)(`p`,{className:`section-kicker`,children:`05 / Trust and limitations`}),(0,Z.jsx)(`h2`,{id:`limits-title`,children:`The honest boundary.`}),(0,Z.jsxs)(`ul`,{children:[(0,Z.jsx)(`li`,{children:`A device that can read the synchronized root key can control Macs on which remote access is enabled. Apple-account recovery and device security are therefore part of Portal’s trust boundary.`}),(0,Z.jsx)(`li`,{children:`The current model has no per-device revocation, emergency account-wide kill switch, or forward secrecy after a later root key compromise. End affected sessions from a trusted Mac if a device is lost.`}),(0,Z.jsx)(`li`,{children:`Traffic analysis and denial of service are not prevented. Subscription checks authorize access but are not a cryptographic trust root.`}),(0,Z.jsx)(`li`,{children:`Commands and completion generators run as the signed-in user on the host Mac. Portal encrypts their transport; it does not sandbox them or prevent those processes from using the network.`})]})]}),(0,Z.jsxs)(`aside`,{children:[(0,Z.jsx)(`strong`,{children:`In one sentence`}),(0,Z.jsx)(`p`,{children:`Nothing leaves the Mac for local sessions; cross-device terminal data leaves only after end-to-end encryption, while metadata and availability remain visible to—or controllable by—the relay.`})]})]}),(0,Z.jsxs)(`footer`,{children:[(0,Z.jsxs)(`a`,{className:`brand`,href:`/portal/`,children:[(0,Z.jsx)(`span`,{"aria-hidden":`true`,children:`>_`}),(0,Z.jsx)(`strong`,{children:`PORTAL`})]}),(0,Z.jsx)(`p`,{children:`SECURITY MODEL`}),(0,Z.jsx)(`p`,{children:`© 2026`})]})]})}var Rc=window.location.pathname.startsWith(`/portal/security`);document.title=Rc?`Security — Portal`:`Portal — Give your Mac a portal`,(0,v.createRoot)(document.getElementById(`root`)).render((0,Z.jsx)(_.StrictMode,{children:Rc?(0,Z.jsx)(Lc,{}):(0,Z.jsx)(Fc,{})}));